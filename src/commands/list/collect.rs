...
/// Discriminant enum for `TaskResult`, used for type-safe tracking of
/// expected vs received results. Generated by `strum::EnumDiscriminants`.
pub(super) use TaskResultDiscriminants as TaskKind;

#[derive(Debug, Clone, strum::EnumDiscriminants)]
#[strum_discriminants(
    name(TaskResultDiscriminants),
